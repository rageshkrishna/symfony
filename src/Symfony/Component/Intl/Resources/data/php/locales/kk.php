...
return array(
    'Names' => array(
        ...
        'am_ET' => 'амхар (Эфиопия)',
        'ar' => 'араб',
        'ar_AE' => 'араб (Біріккен Араб Эмираттары)',
        'ar_BH' => 'араб (Бахрейн)',
        'ar_DJ' => 'араб (Джибути)',
        'ar_DZ' => 'араб (Алжир)',
        'ar_EG' => 'араб (Мысыр)',
        'ar_EH' => 'араб (Батыс Сахара)',
        'ar_ER' => 'араб (Эритрея)',
        'ar_IL' => 'араб (Израиль)',
        'ar_IQ' => 'араб (Ирак)',
        'ar_JO' => 'араб (Иордания)',
        ...
        'ar_LY' => 'араб (Либия)',
        'ar_MA' => 'араб (Морокко)',
        'ar_MR' => 'араб (Мавритания)',
        'ar_OM' => 'араб (Оман)',
        'ar_PS' => 'араб (Палестина аймақтары)',
        'ar_QA' => 'араб (Катар)',
        'ar_SA' => 'араб (Сауд Арабиясы)',
        'ar_SD' => 'араб (Судан)',
        'ar_SO' => 'араб (Сомали)',
        'ar_SS' => 'араб (Оңтүстік Судан)',
        'ar_SY' => 'араб (Сирия)',
        'ar_TD' => 'араб (Чад)',
        'ar_TN' => 'араб (Тунис)',
        'ar_YE' => 'араб (Йемен)',
        ...
        'as_IN' => 'ассам (Индия)',
        'az' => 'әзірбайжан',
        'az_AZ' => 'әзірбайжан (Әзербайжан)',
        'az_Cyrl' => 'әзірбайжан (кириллица)',
        'az_Cyrl_AZ' => 'әзірбайжан (кириллица, Әзербайжан)',
        'az_Latn' => 'әзірбайжан (латын жазылуы)',
        'az_Latn_AZ' => 'әзірбайжан (латын жазылуы, Әзербайжан)',
        'be' => 'беларус',
        'be_BY' => 'беларус (Беларусь)',
        'bg' => 'болгар',
        ...
        'bo_IN' => 'тибет тілі (Индия)',
        'bs' => 'босния',
        'bs_BA' => 'босния (Босния және Герцеговина)',
        'bs_Cyrl' => 'босния (кириллица)',
        'bs_Cyrl_BA' => 'босния (кириллица, Босния және Герцеговина)',
        'bs_Latn' => 'босния (латын жазылуы)',
        'bs_Latn_BA' => 'босния (латын жазылуы, Босния және Герцеговина)',
        'ca' => 'каталан',
        ...
        'cs' => 'чех',
        'cs_CZ' => 'чех (Чех Республикасы)',
        'cy' => 'валлий',
        'cy_GB' => 'валлий (Ұлыбритания)',
        'da' => 'дат',
        'da_DK' => 'дат (Дания)',
        ...
        'fr_CG' => 'француз тілі (Конго Республикасы)',
        ...
        'ha' => 'хауса',
        'ha_GH' => 'хауса (Гана)',
        'ha_Latn' => 'хауса (латын жазылуы)',
        'ha_Latn_GH' => 'хауса (латын жазылуы, Гана)',
        'ha_Latn_NE' => 'хауса (латын жазылуы, Нигер)',
        'ha_Latn_NG' => 'хауса (латын жазылуы, Нигерия)',
        'ha_NE' => 'хауса (Нигер)',
        'ha_NG' => 'хауса (Нигерия)',
        'he' => 'иврит',
        'he_IL' => 'иврит (Израиль)',
        ...
        'ka_GE' => 'грузин (Грузия)',
        'kk' => 'қазақ тілі',
        'kk_Cyrl' => 'қазақ тілі (кириллица)',
        'kk_Cyrl_KZ' => 'қазақ тілі (кириллица, Қазақстан)',
        ...
        'kn_IN' => 'каннада (Индия)',
        'ko' => 'кәріс',
        'ko_KP' => 'кәріс (Оңтүстік Корея)',
        'ko_KR' => 'кәріс (Солтүстік Корея)',
        'ks' => 'кашмир',
        'ks_Arab' => 'кашмир (араб жазылуы)',
        'ks_Arab_IN' => 'кашмир (араб жазылуы, Индия)',
        'ks_IN' => 'кашмир (Индия)',
        'ky' => 'қырғыз',
        'ky_Cyrl' => 'қырғыз (кириллица)',
        'ky_Cyrl_KG' => 'қырғыз (кириллица, Қырғызстан)',
        'ky_KG' => 'қырғыз (Қырғызстан)',
        'lo' => 'лаос',
        'lo_LA' => 'лаос (Лаос)',
        'lt' => 'литва',
        'lt_LT' => 'литва (Литва)',
        ...
        'mk' => 'македон',
        'mk_MK' => 'македон (Македония)',
        'ml' => 'малайялам',
        'ml_IN' => 'малайялам (Индия)',
        'mr' => 'маратхи',
        'mr_IN' => 'маратхи (Индия)',
        'ms' => 'малай',
        'ms_BN' => 'малай (Бруней)',
        'ms_Latn' => 'малай (латын жазылуы)',
        'ms_Latn_BN' => 'малай (латын жазылуы, Бруней)',
        'ms_Latn_MY' => 'малай (латын жазылуы, Малайзия)',
        'ms_Latn_SG' => 'малай (латын жазылуы, Сингапур)',
        ...
        'nl_BQ' => 'голланд (Кариб Нидерландысы)',
        'nl_CW' => 'голланд (Кюрасао)',
        'nl_NL' => 'голланд (Голландия)',
        ...
        'or_IN' => 'ория (Индия)',
        'pa' => 'панджаб',
        'pa_Arab' => 'панджаб (араб жазылуы)',
        'pa_Arab_PK' => 'панджаб (араб жазылуы, Пәкістан)',
        'pa_Guru' => 'панджаб (Гурмукхи)',
        'pa_Guru_IN' => 'панджаб (Гурмукхи, Индия)',
        'pa_IN' => 'панджаб (Индия)',
        'pa_PK' => 'панджаб (Пәкістан)',
        'pl' => 'поляк',
        'pl_PL' => 'поляк (Польша)',
        'ps' => 'пушту',
        ...
        'sq_XK' => 'албан (Косово)',
        'sr' => 'серб',
        'sr_BA' => 'серб (Босния және Герцеговина)',
        'sr_Cyrl' => 'серб (кириллица)',
        'sr_Cyrl_BA' => 'серб (кириллица, Босния және Герцеговина)',
        'sr_Cyrl_ME' => 'серб (кириллица, Черногория)',
        'sr_Cyrl_RS' => 'серб (кириллица, Сербия)',
        'sr_Cyrl_XK' => 'серб (кириллица, Косово)',
        'sr_Latn' => 'серб (латын жазылуы)',
        'sr_Latn_BA' => 'серб (латын жазылуы, Босния және Герцеговина)',
        'sr_Latn_ME' => 'серб (латын жазылуы, Черногория)',
        'sr_Latn_RS' => 'серб (латын жазылуы, Сербия)',
        'sr_Latn_XK' => 'серб (латын жазылуы, Косово)',
        ...
        'tr_TR' => 'түрік (Түркия)',
        'ug' => 'ұйғыр',
        'ug_Arab' => 'ұйғыр (араб жазылуы)',
        'ug_Arab_CN' => 'ұйғыр (араб жазылуы, Қытай)',
        'ug_CN' => 'ұйғыр (Қытай)',
        'uk' => 'украин',
        ...
        'uz_Arab' => 'өзбек (араб жазылуы)',
        'uz_Arab_AF' => 'өзбек (араб жазылуы, Ауғанстан)',
        'uz_Cyrl' => 'өзбек (кириллица)',
        'uz_Cyrl_UZ' => 'өзбек (кириллица, Өзбекстан)',
        'uz_Latn' => 'өзбек (латын жазылуы)',
        'uz_Latn_UZ' => 'өзбек (латын жазылуы, Өзбекстан)',
        ...
        'zh_Hans' => 'қытай тілі (қарапайым қытай иероглифы)',
        'zh_Hans_CN' => 'қытай тілі (қарапайым қытай иероглифы, Қытай)',
        'zh_Hans_HK' => 'қытай тілі (қарапайым қытай иероглифы, Қытай Халық Республикасының Гонг-Конг арнайы әкімшілік ауданы)',
        'zh_Hans_MO' => 'қытай тілі (қарапайым қытай иероглифы, Қытай Халық Республикасының Макао арнайы әкімшілік ауданы)',
        'zh_Hans_SG' => 'қытай тілі (қарапайым қытай иероглифы, Сингапур)',
        'zh_Hant' => 'қытай тілі (дәстүрлік қытай иероглифы)',
        'zh_Hant_HK' => 'қытай тілі (дәстүрлік қытай иероглифы, Қытай Халық Республикасының Гонг-Конг арнайы әкімшілік ауданы)',
        'zh_Hant_MO' => 'қытай тілі (дәстүрлік қытай иероглифы, Қытай Халық Республикасының Макао арнайы әкімшілік ауданы)',
        'zh_Hant_TW' => 'қытай тілі (дәстүрлік қытай иероглифы, Тайвань)',
